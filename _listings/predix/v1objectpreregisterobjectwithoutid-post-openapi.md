...
x-complete: 0
info:
  title: Predix Fingerprint of Things Object Tagging Service Object Pre-Register without
    ID
  description: Pre-register object with image.<br> Individual ID will be issued from
    system.
  contact:
    name: NEC
  version: 1.0.0
