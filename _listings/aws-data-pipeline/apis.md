...
- name: AWS Data Pipeline API Describe Objects
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/objects/master/_listings/aws-data-pipeline/actiondescribeobjects-get-openapi.md
- name: AWS Data Pipeline API Query Objects
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/objects/master/_listings/aws-data-pipeline/actionqueryobjects-get-openapi.md
- name: AWS Data Pipeline API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/objects/master/_listings/aws-data-pipeline/openapi.md
x-common:
- type: x-blog
